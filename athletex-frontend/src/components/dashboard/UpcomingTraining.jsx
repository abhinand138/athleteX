export default function UpcomingTraining({ sessions = [] }) {
      ...
      {sessions.length === 0 ? (
        ...
        <div className="space-y-4 relative z-10">
          ...
          {sessions.map((session, index) => (
            ...
            <div
              key={index}
              className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/5 hover:border-brand-peach/30 transition-all cursor-pointer group/item"
            >
